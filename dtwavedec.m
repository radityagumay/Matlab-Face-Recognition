function [C,L,Cl] = dtwavedec(X,level,biort,qshift);
...
% [C,L,Cl] = dtwavedec(X,level,biort,qshift);
%
...
%     Cl -> This is an optional output argument, that contains the Lo coefficients
%           at every scale.
%
