...
if isstr(biort) & isstr(qshift)		%Check if the inputs are strings
   ...
   if biort_exist == 2 & qshift_exist == 2;        		%Check to see if the inputs exist as .mat files
      ...
      error('Please enter the correct names of the Biorthogonal or Q-Shift Filters, see help DTWAVEREC2 for details.');
   end
else
   error('Please enter the names of the Biorthogonal or Q-Shift Filters as shown in help DTWAVEREC2.');
end
...
while current_level >= 2; ;  %this ensures that for level -1 we never do the following
   ...
   y1 = colifilt(ll,g0b,g0a) + colifilt(hl,g1b,g1a);
   y2 = colifilt(lh,g0b,g0a) + colifilt(hh,g1b,g1a);
...
if current_level == 1;
   ...
   y1 = colfilter(ll,g0o) + colfilter(hl,g1o);
   y2 = colfilter(lh,g0o) + colfilter(hh,g1o);
